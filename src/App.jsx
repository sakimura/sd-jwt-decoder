...
// All SD-JWT parsing/verification logic lives in sdjwt.js (unit-tested).
        ...
        const SDJWTDecoder = () => {
            ...
            const verifySignature = async (jwtString, publicKeyJwk) => {
                try {
                    ...
                    const { protectedHeader } = await verifyIssuerSignature(jwtString, jwk);
            ...
            const decodeSDJWT = async (sdJwt) => {
                try {
                    ...
                    const { jwtString, header, payload, signature, disclosures, kbJwt, presentation } = parseSdJwt(sdJwt);
